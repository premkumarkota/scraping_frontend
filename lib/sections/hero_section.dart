...
class HeroSection extends StatelessWidget {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Container(
          ...
          // Remove fixed height on mobile to fit content
                ...
                child: isMobile
                    ? Column(
                        ...
                        children: [
                          ...
                          _buildRightImage(isMobile: true),
                        ],
                      )
                    : Row(
                        children: [
                          ...
                          Expanded(
                            flex: 4,
                            child: _buildRightImage(isMobile: false),
                          ),
                        ],
                      ),
              ),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            if (!isMobile) // Hide secondary button on very small screens if needed, or keep it
              OutlinedButton(
                onPressed: () {},
  ...
  Widget _buildRightImage({required bool isMobile}) {
    return Center(
      child: Image.asset(
